<template>
   <div>
		...
		<div class="content">
			<div class="header clear"><h2><img :src="articleData.author_face" alt=""/></h2><p>哈哈哈</p></div>
		    <div class="cont">
		    	<h3>{{articleData.title}}</h3>
		        <div class="time"><p>{{articleData.time |timeFilter}} <span><img src="../assets/img/zan.png" alt=""/></span></p></div>
